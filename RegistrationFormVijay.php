...
echo ("Please select Least one option from Profession ");

}
else if ($Experience == $Empty) {

echo ("Please select Least one option from the Experience ");

}
else if ($Country == $Empty) {

echo ("Please select Least one option from the Country ");

}
else if ($State == $Empty) {

echo ("Please select Least one option from the State ");

}
else if ($City == $Empty) {

echo ("Please select Least one option from the City ");

}
else if ($Locality == $Empty) {

echo ("Please select Least one option from the Locality ");

}
else if ($Availability == $Empty) {

echo ("Please select Least one option from the Available ");
...
<tr>
<th></th> 
<th><a href="login.php"><input type="button" value="Existing User Click here" class="city"></a></th>
</tr>
<tr>
<td >Name:*</td>
<td><input type="text" name="Name" placeholder="enter your name"  maxlength="50"required class="city"></td>
</tr>

<tr>
<td>Contact Number: *</td>
<td><input type="text" name="Mobile" placeholder="10 digit Mobile number" pattern="^\d{10}" maxlength="10" required="Please enter valid mobile Number" class="city"></td>
</tr>

<tr>
<td>Email: *</td>
<td><input type="email" name="email" placeholder="enter your Email" required class="city"></td>
</tr>
<tr>
<td>Password: *</td>
<td><input type="password" name="password" placeholder="enter your password" maxlength="20"required class="city"></td>
</tr>
...
<td><input type="submit" value="Save" name="submit" class="city"></td>
</tr>
